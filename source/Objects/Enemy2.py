...
class EnemyHandler2(ObjectBase):
    ...
    def update(self, pressed_keys):
        if self.spawn_countdown.finished:
            ...
            self.add_object("Enemy2", {}, -31, random.randint(0, self.screen.get_height() - 32))


class Enemy2(ObjectBase):
    def __init__(self, screen:pygame.Surface, args: dict, parent:'Room'):
        ObjectBase.__init__(self, screen, args, parent)
    
        self.image = get_image("enemy2")
    ...
    def onscreenleave(self):
        self.delete(self)
        self.change_score(-100000000000000000000000000000)
